local _value = getgenv().RagdollEngine
...
local raghub = utility.create("ScreenGui", {})
raghub.Name = "RagdollShitScript"
raghub.Parent = coreGui

local Mouse = game:GetService("Players").LocalPlayer:GetMouse()
Mouse.KeyDown:Connect(function(Key)
    if Key == "v" then
        library.toggled = not library.toggled
        raghub.Enabled = library.toggled
    end
end)
